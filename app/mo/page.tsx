  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center pt-24 pb-20 px-4 font-sans selection:bg-white/20">
      ...
      <div className="relative w-40 h-40 md:w-48 md:h-48 mb-10 group">
        <div className="absolute inset-0 bg-gradient-to-tr from-purple-600/20 to-fuchsia-500/20 rounded-full blur-3xl scale-150 group-hover:scale-175 transition-transform duration-700 pointer-events-none animate-pulse" />
        <div className="relative w-full h-full z-10 transition-transform duration-500 group-hover:-translate-y-2">
          <img 
            src="/cool.png" 
            alt="Mo Service Avatar" 
            className="w-[260px] h-[260px] md:w-[320px] md:h-[320px] object-contain drop-shadow-[0_20px_50px_rgba(139,92,246,0.3)] transition-transform duration-500 group-hover:scale-110 group-hover:drop-shadow-[0_40px_80px_rgba(139,92,246,0.5)]"
          />
        </div>
      </div>
      <div className="relative z-10 text-center space-y-8 max-w-3xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-medium tracking-tight leading-[1.1]">
          Motion Graphics{' '}
          <span className="font-serif italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-purple-200 via-white to-fuchsia-200 animate-gradient-x ml-2">
            showcase
          </span>
        </h1>
        <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-xl mx-auto font-light border-t border-white/5 pt-6">
          High-end motion graphics and kinetic typography for visually stunning content.
        </p>
        <div className="pt-2">
  ...
  <div className="group relative aspect-video rounded-[32px] overflow-hidden bg-[#0a0a0a] cursor-pointer shadow-2xl shadow-black/50 ring-1 ring-white/5 hover:ring-white/20 transition-all duration-500 hover:shadow-purple-900/20">
    ...
    <div className="absolute bottom-0 left-0 right-0 p-6 flex justify-between items-end translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
      <div>
        ...
        <div className="h-1 w-12 bg-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100"></div>
      </div>
      {duration && (
...
export default MoGraphShowcase;
